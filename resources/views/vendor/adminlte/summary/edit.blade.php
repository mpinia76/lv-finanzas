...
@section('main-content')
		...
		<div class="box box-primary">
            <div class="box-header with-border">
              <i class="fa fa-edit"></i> <h3 class="box-title">Editar Movimiento</h3>
         ...
         @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form id="search-form" role="form" action = "{{ url('/summary/editar')}}/{{$data->id}}" method="post"  enctype="multipart/form-data">
